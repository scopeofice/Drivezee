...
const Home_sg = () => {
  return (
    <>
      ...
      <section className="section about" id="about" aria-label="about" style={{marginBottom:"0px", paddingBottom:"0px"}}>
        <div className="container">
...
{/*Video*/}
<section className="video has-bg-image" aria-label="video" style={{backgroundImage: `url('../../public/video-bg.png')`}}>
      <div className="container">
        <div className="video-card">
          <div className="video-banner img-holder has-after" style={{'--width': '', '--height': ''}}>
            <img src="../../public/video-pic.jpg" width="970" height="550" loading="lazy" alt="video banner" className="img-cover" />
            <button className="play-btn" aria-label="play video">
              <ion-icon name="play" aria-hidden="true"></ion-icon>
            </button>
          </div>
          <img src="../../public/video-shape-1.png" width="1089" height="605" loading="lazy" alt="" className="shape video-shape-1" />
          <img src="../../public/video-shape-2.png" width="158" height="174" loading="lazy" alt="" className="shape video-shape-2" />
        </div>
      </div>
    </section>
    ...
    <section
      ...
      >
        <div className="container">
          ...
          <p className="section-text">Master Driving with Canada's Finest Instructors</p>
          <ul className="grid-list">
            <li>
              <div
                className="category-card"
      ...
      <div className="container">
          ...
          <li>
            <div className="blog-card">
              ...
              <div className="card-content">
                ...
                <a href="#" className="card-subtitle"><span>⭐⭐⭐⭐⭐</span></a>
                <h3 className="h3">
                  <a href="#" className="card-title">"Great driving school! Excellent instructors, highly recommended!" </a>
                </h3>
          ...
          <li>
            <div className="blog-card">
              ...
              <div className="card-content">
                ...
                <a href="#" className="card-subtitle"><span>⭐⭐⭐⭐⭐</span></a>
                <h3 className="h3">
                  <a href="#" className="card-title">"The best driving school in town! Very professional and patient instructors." </a>
                </h3>
                <ul className="card-meta-list">
                  <li className="card-meta-item">
                    <ion-icon name="person-outline" aria-hidden="true"/>
          ...
          <li>
            <div className="blog-card">
              ...
              <div className="card-content">
                ...
                <a href="#" className="card-subtitle"><span>⭐⭐⭐⭐⭐</span></a>
                <h3 className="h3">
                  <a href="#" className="card-title">"Amazing experience! I passed my driving test on the first attempt!" </a>
                </h3>
                <ul className="card-meta-list">
                  <li className="card-meta-item">
                    <ion-icon name="person-outline" aria-hidden="true"/>
        ...
        <img src="../../public/blog-shape.png" width="186" height="186" loading="lazy" alt=""
